...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f3f2ef] relative overflow-hidden py-10 px-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <User className="absolute left-3.5 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-[#0a66c2] transition-colors" />
                <input
                  type="text"
                  name="fullName"
            ...
            {/* Avatar Section */}
            <div className="flex items-center gap-4 py-3 px-4 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
              <div className="w-14 h-14 rounded-xl bg-white shadow-sm flex items-center justify-center overflow-hidden border border-gray-200">
              ...
              <div className="flex-1">
                ...
                <label
                  ...
                  className="text-sm font-medium text-[#0a66c2] cursor-pointer flex items-center gap-2 hover:text-[#004182] transition-colors"
                >
            ...
            <button
              ...
              className="w-full bg-[#0a66c2] text-white py-3.5 rounded-xl font-semibold hover:bg-[#004182] transition-all active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-70 shadow-sm hover:shadow-md mt-2"
            >
              {formState.loading ? (
                <>

...
import { employerFeatures, jobSeekerFeatures } from "../../../utlis/data";
          ...
          <div>
            ...
            <div className="space-y-8">
              {employerFeatures.map((feature, index) => (
                <div
                  key={index}
                  className="flex items-start space-x-4 p-6 rounded-2xl hover:bg-purple-50 transition-all duration-300 cursor-pointer group"
                >
